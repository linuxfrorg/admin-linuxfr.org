...
declared_lxc_containers="alpha bla main prod"
...
check_process "bla"  "etherpad-lite" "pad"       "safeRun.sh"
check_socket  "bla"  "etherpad-lite" "tcp"       "127.0.0.1:9001"   "0.0.0.0:\*"        "LISTEN"         1
check_socket  "bla"  "etherpad-lite" "tcp"       "127.0.0.1:3306"   "127.0.0.1:[0-9]*"  "$not_listening" "" ${bla_pad_conn}
check_socket  "bla"  "etherpad-lite" "tcp"       "127.0.0.1:[0-9]*" "127.0.0.1:3306"    "$not_listening" "" ${bla_pad_conn}
check_process "bla"  "etherpad-lite" "pad"       "run.sh"
check_process "bla"  "etherpad-lite" "pad"       "server.js"
